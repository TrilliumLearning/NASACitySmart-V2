...
const app      = express();
const config = require('./Backup4/config/mainconf');
...
require('./Backup4/routes/passport')(passport); // pass passport for configuration
...
// routes ======================================================================
require('./Backup4/routes/routes.js')(app, passport); // load our routes and pass in our routes and fully configured passport
